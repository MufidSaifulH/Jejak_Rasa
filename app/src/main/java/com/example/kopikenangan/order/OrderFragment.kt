package com.example.kopikenangan.order
...
//        showRecyclerList()
        ...
        orderViewModel.listOutlet.observe(requireActivity()) { outlet ->
    ...
    private fun setOutletData(outlet:  List<DataOutlet>) {
        val adapter = OutletAdapter()
        adapter.submitList(outlet)
